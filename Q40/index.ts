...
// add that value to the album’s Object. Make at least one new function call that includes the number of 
// tracks on an album.
...
make_album({artist:"Artist1",title:"album1"});
make_album({artist:"Artist2",title:"album2"});
make_album({artist:"Artist3",title:"album3",track:10})