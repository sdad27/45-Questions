...
// the pizza. For each pizza you should have one line of output containing a simple statement like 
...
let favorite_pizza : string[] = ["pepperoni","BBQ Chicken","Smokie BBQ"];
favorite_pizza.forEach(pizzas => {
