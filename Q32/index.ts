...
let current_users : string[] = ["saeed","ahmed","khizar","ali","qusai"];
let new_users : string[] = ["nasir","saeed","ali","tabish","daniyal"];

//for case insensitive

let curr_usersLower : string[] = current_users.map(user => user.toLowerCase());
